...
public class QuizTime {
	...
	public static void main(String[] args) throws QuizBaseException, InterruptedException {
		...
		quiz.addQuestion(new MultipleChoiceQuestion("Who created Star Wars?", new MultipleChoiceAnswer('A', "George Lucas"), new MultipleChoiceAnswer('A', "George Lucas"), new MultipleChoiceAnswer('B', "Steven Spielberg"), new MultipleChoiceAnswer('C', "Denis Villeneuve"), new MultipleChoiceAnswer('D', "Robert Jordan")));
		quiz.addQuestion(new FillInTheBlankQuestion("\"Help me Obi-Wan Kenobi. You are my only hope\" was said by Princess ____", "Leia"));
		quiz.addQuestion(new MultipleChoiceQuestion("What is Darth Sidious's real name?", new MultipleChoiceAnswer('D', "Sheev Palpatine"), new MultipleChoiceAnswer('A', "Quintus Palpatine"), new MultipleChoiceAnswer('B', "Valkorion"), new MultipleChoiceAnswer('C', "Anakin Skywalker"), new MultipleChoiceAnswer('D', "Sheev Palpatine")));
		...
		quiz.addQuestion(new MultipleChoiceQuestion("Padme Amidala was queen of what planet?", new MultipleChoiceAnswer('B', "Naboo"), new MultipleChoiceAnswer('A', "Korriban"), new MultipleChoiceAnswer('B', "Naboo"), new MultipleChoiceAnswer('C', "Aldeeran"), new MultipleChoiceAnswer('D', "Coruscant")));
		quiz.addQuestion(new ShortAnswerQuestion("Do you believe that Revan was correct in his decision to defy the Jedi High Council and join the Mandalorian Wars? Why or why not?"));
